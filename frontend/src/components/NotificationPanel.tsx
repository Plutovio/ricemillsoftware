...
export function NotificationPanel({ onClose }: NotificationPanelProps) {
  ...
  return (
    <div
      ref={panelRef}
      className="absolute right-0 mt-2 w-80 bg-white border border-gray-200 rounded-xl shadow-lg z-50 overflow-hidden animate-slide-down"
    >
      <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
        <h3 className="text-xs font-semibold text-gray-900 uppercase tracking-wider">Alerts & Notifications</h3>
      ...
      <div className="max-h-80 overflow-y-auto divide-y divide-gray-100">
        {loading ? (
          <div className="p-4 text-center text-xs text-gray-500 font-medium">Loading notifications...</div>
          ...
          expiringSoonRecords.map((bg) => {
            ...
            return (
              <div key={bg.id} className="p-4 hover:bg-gray-50 transition-colors flex flex-col gap-1">
